        ...
        child: OverflowBox(
          ...
          child: Row(
            children: [
              ...
              SizedBox(width: expandedWidth, child: child),
            ],
          ),
        ),
      ),
        ...
        child: Semantics(
          ...
          child: AnimatedContainer(
            ...
            child: CustomPaint(
              ...
              // Expanded → chevron points right-toward-the-edge ("close it").
              // Collapsed → chevron points left ("open it back out").
              painter: _ChevronPainter(
                pointRight: widget.collapsed,
                color: fg,
              ),
            ),
          ),
...
/// A single chevron drawn from primitives (no glyph font, so never tofu).
class _ChevronPainter extends CustomPainter {
  final bool pointRight;
  final Color color;

  _ChevronPainter({required this.pointRight, required this.color});
